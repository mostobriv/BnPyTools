...
class ShowSwitchCases(PyToolsPluginCommand):
	display_name = "Show cases of switch"
	...
	def activate(self, bv, instr):
		...
		if (default := switch_instr.default).operation != binaryninja.HighLevelILOperation.HLIL_NOP:
...
get_action_manager().register(ShowSwitchCases())
