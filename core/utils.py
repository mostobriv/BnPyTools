...
# https://github.com/Vector35/binaryninja-api/blob/0fdf63/python/scriptingprovider.py
def get_il_view_type(context: binaryninjaui.UIActionContext) -> Optional[FunctionGraphType]:
    view_location = context.context.getCurrentViewFrame().getViewLocation()
